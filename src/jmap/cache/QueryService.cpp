...
namespace javelin::jmap::cache
{
                                         ...
                                         const std::vector<std::string>& emailIds) const
    {
        ...
        query.prepare(QStringLiteral(
            ...
            "  INNER JOIN emails e2 ON e2.account_id=:account_id AND e2.thread_id=rt.thread_id "
            ...
            "thread_has_flagged "
            "  FROM requested_threads rt "
            "  INNER JOIN emails e3 ON e3.account_id=:account_id AND e3.thread_id=rt.thread_id "
