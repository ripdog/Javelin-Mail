    ...
    std::vector<ConnectionSettings> GuiSettings::accounts() const
    {
        ...
        for (const auto& account : snapshot().accounts)
        {
            ...
            result.push_back({
                ...
                .oauthIssuer = account.oauthIssuer.trimmed(),
                .oauthResource = account.oauthResource.trimmed(),
                .oauthScope = account.oauthScope.simplified(),
                .revocationEndpoint = account.revocationEndpoint.trimmed(),
                .registrationClientUri = account.registrationClientUri.trimmed(),
                .registrationAccessToken = account.registrationAccessToken.trimmed(),
    ...
    GuiSettings::protocolAccounts(const std::vector<ConnectionSettings>& accounts)
    {
        ...
        for (const auto& account : accounts)
        {
            result.push_back({
                ...
                .oauthResource = account.oauthResource,
