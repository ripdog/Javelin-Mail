...
namespace javelin::app::undo
{
    ...
    {
      public:
        MailTransferHistoryService(javelin::jmap::cache::DatabaseConnection& databaseConnection,
        ...
        getAuthoritativeEmails(std::string accountId,
                               std::vector<std::string> emailIds) override;
