...
namespace javelin::app
{
                                                                       ...
                                                                       const QStringList& threadIds)
    {
        ...
        mailboxWindows.prepare(QStringLiteral(
            ...
            "requested r INNER JOIN emails e INDEXED BY idx_emails_thread ON "
            "e.account_id=:account_id AND e.thread_id=r.thread_id INNER JOIN "
        ...
        searchWindows.prepare(QStringLiteral(
            ...
            "INNER JOIN emails e INDEXED BY idx_emails_thread ON e.account_id=:account_id AND "
            "e.thread_id=r.thread_id INNER JOIN search_window_items i INDEXED BY "
